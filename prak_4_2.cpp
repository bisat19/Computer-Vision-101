...
void KotakKayu2() {
    ...
    glBegin(GL_QUADS);
    glVertex3f(-3.0f, -3.0f, 0.0f); // Kiri bawah
    glVertex3f(3.0f, -3.0f, 0.0f);  // Kanan bawah
    glVertex3f(2.0f, 1.5f, 0.0f);   // Kanan atas
    glVertex3f(-2.0f, 1.5f, 0.0f);  // Kiri atas
    glEnd();
    glPopMatrix();
    ...
    glTranslatef(7.0f, 0.0f, 3.0f);
    glRotatef(180, 0, 1, 0); // Belok 180 derajat
    glBegin(GL_QUADS);
    glVertex3f(-3.0f, -3.0f, -6.0f); // Kiri bawah
    glVertex3f(3.0f, -3.0f, -6.0f);  // Kanan bawah
    glVertex3f(2.0f, 1.5f, -6.0f);   // Kanan atas
    glVertex3f(-2.0f, 1.5f, -6.0f);  // Kiri atas
    glEnd();
    glPopMatrix();
    ...
    glTranslatef(7.0f, 0.0f, 3.0f);
    glRotatef(-90, 1, 0, 0); // Miring ke atas
    glBegin(GL_QUADS);
    glVertex3f(-2.0f, 1.5f, 0.0f);  // Kiri depan
    glVertex3f(2.0f, 1.5f, 0.0f);   // Kanan depan
    glVertex3f(2.0f, 1.5f, -6.0f);  // Kanan belakang
    glVertex3f(-2.0f, 1.5f, -6.0f); // Kiri belakang
    glEnd();
    glPopMatrix();
    ...
    glTranslatef(7.0f, 0.0f, 3.0f);
    glRotatef(90, 1, 0, 0); // Miring ke bawah
    glBegin(GL_QUADS);
    glVertex3f(-3.0f, -3.0f, 0.0f); // Kiri depan
    glVertex3f(3.0f, -3.0f, 0.0f);  // Kanan depan
    glVertex3f(3.0f, -3.0f, -6.0f); // Kanan belakang
    glVertex3f(-3.0f, -3.0f, -6.0f); // Kiri belakang
    glEnd();
    glPopMatrix();
    ...
    glTranslatef(7.0f, 0.0f, 3.0f);
    glRotatef(90, 0, 1, 0); // Miring ke kiri
    glBegin(GL_QUADS);
    glVertex3f(-3.0f, -3.0f, 0.0f); // Kiri bawah
    glVertex3f(-3.0f, -3.0f, -6.0f);// Kiri atas
    glVertex3f(-2.0f, 1.5f, -6.0f); // Kanan atas
    glVertex3f(-2.0f, 1.5f, 0.0f);  // Kanan bawah
    glEnd();
    glPopMatrix();
    ...
    glTranslatef(7.0f, 0.0f, 3.0f);
    glRotatef(-90, 0, 1, 0); // Miring ke kanan
    glBegin(GL_QUADS);
    glVertex3f(3.0f, -3.0f, 0.0f);  // Kiri bawah
    glVertex3f(3.0f, -3.0f, -6.0f); // Kiri atas
    glVertex3f(2.0f, 1.5f, -6.0f);  // Kanan atas
